...
/**
 * Displays notifications for service worker updates and offline readiness in a Progressive Web App.
 *
 * Shows a persistent update prompt when a new version is available, allowing users to reload and update or dismiss the notification. Briefly displays an offline readiness notification when the app is ready for offline use, which auto-hides after a configurable delay.
 *
 * @param autoHideDelay - Duration in milliseconds before the offline notification auto-hides. Defaults to 5000.
 */
